    ...
    <div class="row g-5">
     ...
     echo "
      ...
      <li class='list-group-item d-flex justify-content-between lh-sm'>
            <div>
              <h6 class='my-0'>$displaycart[productname]</h6>
              <small class='text-body-secondary'>₹$displaycart[productprice]xNo's$displaycart[quantity]</small>
            </div>
            <span class='text-body-secondary'>₹$individual</span>
          </li>
        </ul>";
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" method="post" novalidate>
          ...
          <button class="w-100 btn btn-warning btn-lg" name="submit" type="submit"><a href="orderpdf.php">Continue to Download your order receipt</a></button>
...
if(isset($_POST['submit'])){
    ...
    $insertquery = "INSERT INTO orders(id,customerid,name,email,address,country,state,zip) 
                    VALUES($orderid,$userid,'$personname','$personemail','$personaddress','$personcountry','$personstate','$personzip')";
